...
const faqs = [
  ...
  },
  {
    ...
    a: 'Run npx @calabamatex/agentsentry enable for an interactive wizard, or set --level on init. Each level adds skills incrementally \u2014 no disruption to existing workflows.',
  },
];
