...
export const demoScenarios: DemoScenario[] = [
  {
    ...
    lines: [
      { type: 'command', text: '$ npx @calabamatex/agentsentry init --level 2' },
  ...
  },
  {
    ...
    lines: [
      { type: 'command', text: '$ npx @calabamatex/agentsentry health' },
      { type: 'output', text: '' },
  ...
  },
  {
    ...
    lines: [
      { type: 'command', text: '$ npx @calabamatex/agentsentry scan --file src/config.ts' },
      { type: 'output', text: '' },
  ...
  },
  {
    ...
    lines: [
      { type: 'command', text: '$ npx @calabamatex/agentsentry memory search "auth token refresh"' },
      { type: 'output', text: '' },
  ...
  },
  {
    ...
    lines: [
      { type: 'command', text: '$ npx @calabamatex/agentsentry size-task' },
      { type: 'output', text: '' },
